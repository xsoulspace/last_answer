...
> **Historical handoff; do not execute its remaining task list.** Its
> embedded-only/console-first ordering is superseded. Use
> [HANDOFF-agents-in-docs.md](HANDOFF-agents-in-docs.md),
> [ADR 0012](decisions/0012-writable-agent-doc-and-acp-client-first.md)
> and [PLAN.md](PLAN.md): the writable shared document and Last Answer's
> outbound ACP-client path come first; external operator ingress follows proof.
