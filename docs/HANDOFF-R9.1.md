...
> **Historical handoff; do not execute its remaining task list.** Its AFM
> quality findings remain historical evidence, but the old C0–C6/
> console-first ordering is no longer the forward plan. Use
> [HANDOFF-agents-in-docs.md](HANDOFF-agents-in-docs.md),
> [ADR 0012](decisions/0012-writable-agent-doc-and-acp-client-first.md)
> and [PLAN.md](PLAN.md) for the writable shared-document and
> ACP-client-first sequence.
