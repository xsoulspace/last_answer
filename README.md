...
> [!WARNING]
> The current development version is entering a highly unstable phase and is
> expected to break. Do not rely on it for production work; back up important
> project data before testing development builds. Clean-checkout dependency
> setup is incomplete and builds may require local sibling packages. This is
> a development-stage warning, not a stability statement about any particular
> published release.
