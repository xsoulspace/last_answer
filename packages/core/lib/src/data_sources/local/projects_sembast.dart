...
import '../../../core.dart';
import '../local_sembast/local_sembast.dart';

final class ProjectsLocalDataSourceSembastImpl
    implements ProjectsLocalDataSource {
  ProjectsLocalDataSourceSembastImpl({
    required this.sembastDB,
  });
  final ComplexLocalDbSembastWebImpl sembastDB;
