...
Task brief: local harness-mobile-feasibility brief.
...
- `xsoulspace_agentic_harness` → `../../ecsai_harness/pkgs/xsoulspace_agentic_harness`
- `xsoulspace_agentic_host` → `../../ecsai_harness/pkgs/xsoulspace_agentic_host`
- `xsoulspace_agentic_workspace` → `../../ecsai_harness/pkgs/xsoulspace_agentic_workspace`
- `xsoulspace_agentic_afm` → `../../ecsai_harness/pkgs/xsoulspace_agentic_afm` (AFM composition root, `appleFoundationBinding`)
- `xsoulspace_inference_core` / `xsoulspace_inference_openrouter` / `xsoulspace_inference_apple_foundation` → `../dart_flutter_packages/pkgs/`
- App side → `last_answer/lib/coding_agent/`

Harness, host, workspace, and the AFM composition root use the sibling `ecsai_harness` checkout; inference transports use the sibling `dart_flutter_packages` checkout.
