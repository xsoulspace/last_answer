...
// Minimum logical pixel size of the SvgIconButton.
...
///
/// This sample shows an `SvgIconButton` that uses the Material icon "volume_up" to
/// increase the volume.
///
...
/// widget whose child is an [SvgIconButton]. The icon button's filled background
...
class SvgIconButton extends StatelessWidget {
  ...
  /// [Icon.size] property allows the [SvgIconButton] to size the splash area to
  /// fit the [Icon]. If you were to set the size of the [Icon] using
  /// [Icon.size] instead, then the [SvgIconButton] would default to 24.0 and then
  ...
  /// Defines how the icon is positioned within the SvgIconButton.
  ///
