      ...
      div([
        section(
          [
            div([
              h1(
                [Component.text('Think fast, write faster')],
                classes:
                    'text-5xl md:text-8xl tracking-tighter'
              ...
              ...[
                ...
                (e) => Card([
                  ...
                  h3(
                    ...
                    classes: 'font-semibold text-3xl tracking-wide md:text-4xl',
                  ),
                  TwSpacer.y('8'),
                  p([Component.text(e.description)], classes: 'text-xl'),
                  TwSpacer.y('2'),
                ], classes: ''),
              ),
            ],
        ...
        [
          ...
          div([
            h1(
              ...
              [Component.text('Never lose thoughts in the breeze of time')],
              classes:
