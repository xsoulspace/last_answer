...
class Envs {
  ...
  static final serverRedirectUri = Uri.parse(
    '${const String.fromEnvironment("SERVER_REDIRECT_HOST", defaultValue: "http://localhost:8082/")}googlesignin',
  );
  static const googleClientId = String.fromEnvironment('GOOGLE_CLIENT_ID');
  static const googleServerClientId = String.fromEnvironment(
    'GOOGLE_SERVER_CLIENT_ID',
  );
  static bool get isFeedbackAvailable => false; // wiredashProjectId.isNotEmpty;
